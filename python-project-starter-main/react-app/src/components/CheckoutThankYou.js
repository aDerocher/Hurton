        ...
        <div className="splash-btns-cont">
          <NavLink to="/" className="github-link">
            <button className="splash-btn">
              <p className="thankyou-btn">Hurton Home</p>
            </button>
          </NavLink>
          {!sessionUser && (
            <NavLink to="/sign-up" className="github-link">
              <button className="splash-btn">
                <p className="thankyou-btn">Create An Account</p>
              </button>
            </NavLink>
          )}
          {sessionUser && (
            <NavLink
              to={`/users/${sessionUser.id}/order-history`}
              className="github-link"
            >
              <button className="splash-btn">
                <p className="thankyou-btn">My Order History</p>
              </button>
            </NavLink>
          )}
        </div>
