  ...
  return (
    <div className="splash-page-container">
      <div className="ak-advert">
        <p>
          Layers for anywhere you go{" "}
          <span className="ak-link">
            <NavLink
              to={`/shop`}
              exact={true}
      ...
      <div className="splash-photo-container">
        ...
        <p className="splash-text">
          Ever wonder what gear your favorite snowboarder uses? Head to <br />
          the Hurton Blog to find out which board each rider calls their tried
          and true, or check out <br />
          our round-up to explore their complete setups.
        </p>
      ...
      <div className="content-width shop-sections-container">
        <div className="shop-section">
          <img
            src="https://hurton.s3.us-west-2.amazonaws.com/Hurton-downloadedImages/splash-jackets.jpg"
            alt="shop"
        ...
        <div className="shop-section">
          <img
            src="https://hurton.s3.us-west-2.amazonaws.com/Hurton-downloadedImages/splash-bibs-pants.jpg"
            alt="shop"
            className="shop-section-img"
          />
        ...
        <div className="shop-section">
          <img
            src="https://hurton.s3.us-west-2.amazonaws.com/Hurton-downloadedImages/splash-fleece.jpg"
            alt="shop"
            className="shop-section-img"
          />
        ...
        <div className="shop-section">
          <img
            src="https://hurton.s3.us-west-2.amazonaws.com/Hurton-downloadedImages/splash-kids.jpg"
            alt="shop"
            className="shop-section-img"
          />
      ...
      <div className="stepon-section-container content-width">
        <div>
          ...
          <h2 className="stepon-title">
            Custom Graphics<span className="stepon-r"> ®</span>
          </h2>
          <p className="stepon-text">
            Good news, everyone. The new Custom Hurt® graphic designs are
            almost here.
            <br />
