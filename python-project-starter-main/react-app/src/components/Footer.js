    ...
    <div className="footer-container main-container ">
      ...
      <div className="footer-top content-width">
        <div className="footer-top-section">
          ...
          <ul>
            <li className="link-green">
              <NavLink to="/about" style={{ color: `var(--link-green)` }}>
                {" "}
                <p className="github-link">About Hurton</p>
              </NavLink>
            </li>
            <li>
              <a
              ...
              >
                <i className="fab fa-github"> </i> Creators Github
              </a>
            </li>
            <li>
              <a
                ...
                className="github-link"
              >
                <i className="fab fa-linkedin"> </i> Creators Linkedin
              </a>
            </li>
            <li>
              <a
                href="https://angel.co/u/andrew-derocher"
                target="_blank"
                className="github-link"
              >
                <i className="fab fa-angellist"> </i> Creators AngelList
              </a>
            </li>
      ...
      <div className="footer-bottom content-width">
        <div className="footer-bottom-section fbs-1">
          ...
          <p className="grey-label">©2021 Hurton Snowboards</p>
          <p>·</p>
        </div>
