    ...
    return (
        <div className='profile-sidebar'>
            ...
            <div className='pr-nav-options'>
                <NavLink to={`/users/${userId}`} style={{ textDecoration: 'underline', color: `var(--link-green)`}}>
                    <button className='pr-nav-btn'>Info & Preferences</button>
                </NavLink>
                <NavLink to={`/users/${userId}/order-history`} style={{ textDecoration: 'underline', color: `var(--link-green)`}}>
                    <button className='pr-nav-btn'>Order History</button>
                </NavLink>
                <NavLink to={`/users/${userId}/wishlist`} style={{ textDecoration: 'underline', color: `var(--link-green)`}}>
