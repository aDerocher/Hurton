    ...
    return (
        <div className="review-container">
            <form action={`/items/${itemId}/new-review`}>
                ...
                {revErrors.map((e, i) => (
                    <p hidden={hideRevErrors} className='error' key={i}>{e}</p>
                ))}
                <div className='flex-col-cont'>
                    <label className='grey-label'><span hidden={hideRevErrors} className='req-star'> *</span> Score</label>
                    <input type='number'
                ...
                <div className='flex-col-cont'>
                    <label className='grey-label'><span hidden={hideRevErrors} className='req-star'> *</span> Title</label>
                    <input type='text'
                    className='rev-input'
                        value={revTitle}
