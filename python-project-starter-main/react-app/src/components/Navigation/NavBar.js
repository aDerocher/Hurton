        ...
        <div className="meta-nav">
          <div className="meta-nav-section">
            ...
            <NavLink to="/about" style={{ color: `var(--link-green)` }}>
              {" "}
              <p className="small-text github-link">About Hurton</p>
            </NavLink>
          </div>
          ...
          <div className="meta-nav-section">
            {sessionUser && (
              <NavLink
                to={`/users/${sessionUser?.id}/wishlist`}
                exact={true}
                activeClassName="active"
                style={{ textDecoration: "none", color: `var(--link-green)` }}
              >
                <button className="btn-simple heart-btn-simple">
        ...
        <div className="nav content-width">
          ...
          <div className="nav-img-section">
            <NavLink to="/" exact={true} activeClassName="active">
              <img
                id="h-logo"
                className="hurton-nav-logo"
                src="https://hurton.s3.us-west-2.amazonaws.com/Hurton-downloadedImages/hurton-logo-2.png"
                alt="Hurton"
              />
              <img
                id="text-logo"
